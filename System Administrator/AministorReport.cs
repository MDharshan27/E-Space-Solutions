    ...
    public partial class AministorReport : Form
    {
        ...
        private void LoadReportData()
        {
            using (SqlConnection conn = new SqlConnection(connectionString))
            {
                ...
                {
                    conn.Open();
                    string query = "SELECT ReportID, ID, ReportType, ReportMessage " +
                                   "FROM Report " +
                                   "WHERE ReportType IN ('Colonist Report', 'Trip Report with Passengers', 'Jet Detail Report')";
